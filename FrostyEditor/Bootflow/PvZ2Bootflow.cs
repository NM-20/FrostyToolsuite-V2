...
internal unsafe sealed class PvZ2Bootflow : BootflowBase
{
        ...
        void *unknown5, void *unknown6)
    {
        ...
        const string pattern =
            "48 89 5C 24 08 48 89 74 24 10 57 48 83 EC 20 49 8B F8 48 8B D9 E8 ?? ?? ?? ?? 48 8D";
    ...
    public override void Initialize(IHook<NativeEntrypointFunction> hook)
    {
        ...
        const string pattern = "40 55 53 56 57 41 54 41 55 41 56 41 57 48 8D AC 24 78 FF";
